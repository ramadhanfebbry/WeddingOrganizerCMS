        ...
        <section class="properties_area p_120">
          <div class="container">
            <div class="col-lg-8 col-md-8">
                <h3 class="mb-30 title_color">Tambah Barang</h3>
                <form action="#">
                  <div class="mt-10">
                    <input type="text" name="nama_barang" placeholder="Nama Barang" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nama Barang'" required="" class="single-input">
                  </div>
                  <div class="mt-10">
                    <input type="number" name="harga_barang" placeholder="Harga Barang" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Harga Barang'" required="" class="single-input" min="0">
                  </div>
<div class="mt-10">

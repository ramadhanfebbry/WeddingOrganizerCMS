    ...
    <div class="container">
      <div class="table-wrapper">
        <div class="table-title">
          <div class="row">
            <div class="col-sm-6">
              <h2>Manage <b>Jasa</b></h2>
            </div>
            <div class="col-sm-6">
              <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="fa fa-plus-circle"></i> <span>Add New Pemesanan</span></a>
              <a href="#deleteEmployeeModal" class="btn btn-danger" class="delete" data-toggle="modal"><i class="fa fa-trash-o"></i> <span>Delete</span></a>            
            </div>
          </div>
        </div>
        ...
        <div class="modal-content">
          <form action="create.php" method="POST">
            <div class="modal-header">            
              <h4 class="modal-title">Add Jasa</h4>
  ...
  <!--================ start footer Area  =================-->  
    ...
    <script type="text/javascript">
     function setFormEdit(dom){
        ...
        var nama = $(dom).parent().parent().children("td.nama").html();
        var harga = $(dom).parent().parent().children("td.harga").html();
        var status = $(dom).parent().parent().children("td.status").html();

        $(".form-edit").attr("action", "update.php?id="+ id);
        $(".form-edit input[name='nama']").val(nama);
        $(".form-edit input[name='harga']").val(harga);
        $(".form-edit select[name='status']").val(status);
     }
